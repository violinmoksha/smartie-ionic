...
export class FirebaseMock extends Firebase {
    ...
    getToken(): Promise<any> {
        return new Promise((resolve, reject) => {
            resolve('ewCVcq2MitU:APA91bEoTcHJiPt8JjRkTsRjdo2isAuPvj8l5EziijcL7p_taK6IrSqAe9f9L3WvbbeUxMR743hEnqrM-RrTpwI-UO2wJVYK6MRLU7JpWVXnzzYa0ZdP6I4GzjHeO08I95VJWTcdD6Wk65ytAs-iGiqwGa9CgOWbzg');
        });
    };
    /**
