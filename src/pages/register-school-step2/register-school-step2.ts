...
@IonicPage()@Component({
  selector: 'page-register-school-step2',
  templateUrl: 'register-school-step2.html',
})
export class RegisterSchoolStep2Page {
  ...
  next(form2Value){
    this.navCtrl.push("RegisterSchoolStep3Page", { form1Value: this.form1Values, form2Value : form2Value });
  }
