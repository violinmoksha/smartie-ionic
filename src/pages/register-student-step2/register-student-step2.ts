...
/**
 * Generated class for the RegisterStudentStep2Page page.
 *
...
@IonicPage()@Component({
  selector: 'page-register-student-step2',
  templateUrl: 'register-student-step2.html',
})
export class RegisterStudentStep2Page {
  ...
  next(form2Value){
    this.navCtrl.push("RegisterStudentStep3Page", { form1Value: this.form1Values, form2Value : form2Value, partOfSchool: this.partOfSchool });
  }
