...
export class RegisterStudentStep3Page {
  ...
  StudentSubmit(studentData){
    ...
    let API = this.smartieApi.getApi(
      ...
      {role: 'student', username: this.form1Values.username, password: this.form1Values.password, email: this.form1Values.email, fullname: this.form2Values.name, phone: this.form2Values.phone, profileabout: this.form2Values.profileMessage, preflocation: studentData.prefLocation, prefpayrate: this.hourlyRate, prefcurrency: this.userCurrency, partofschool: this.partOfSchool, schoolname: this.form2Values.studentSchoolName, langpref: 'en'}
    );
